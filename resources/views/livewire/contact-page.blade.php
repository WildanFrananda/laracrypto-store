        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="relative h-96 md:h-full min-h-[400px] rounded-lg overflow-hidden">
                    <img src="https://placehold.co/600x800/e5e7eb/333333?text=Contact+Us" alt="Contact Us" class="absolute inset-0 w-full h-full object-cover">
                ...
                <div>
                    ...
                    @else
                        <h2 class="text-2xl font-semibold text-gray-900 mb-2">What can we help?</h2>
                        <form wire:submit.prevent="submitForm" class="space-y-6">
                            ...
                            <div>
                                <button type="submit" class="w-full bg-amber-600 text-white py-3 px-6 rounded-md hover:bg-amber-700 disabled:opacity-50">
                                    Submit
                                </button>
                            </div>
                        </form>
